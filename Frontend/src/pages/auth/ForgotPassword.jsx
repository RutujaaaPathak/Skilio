    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center p-gutter">
        <div className="card max-w-md w-full p-lg text-center">
          <Icon name="mail" className="text-secondary text-5xl mb-md" />
          <h2 className="text-headline-lg font-bold text-primary mb-sm">Check Your Email</h2>
          <p className="text-body-md text-on-surface-variant mb-lg">
            If an account with <strong>{email}</strong> exists, we've sent a password reset link.
          </p>
          <Link to="/" className="px-md py-sm bg-primary text-on-primary font-bold rounded-lg inline-block hover:opacity-90">
            Back to Login
          </Link>
        </div>
      </div>
