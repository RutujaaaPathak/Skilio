...
from app.schemas.proctor import ProctorEventCreate, ProctorEventResponse, ProctorEventResponseWithRisk
...
__all__ = [
    ...
    "ProctorEventCreate", "ProctorEventResponse", "ProctorEventResponseWithRisk",
]